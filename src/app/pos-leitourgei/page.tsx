...
export const metadata: Metadata = {
  ...
  description:
    "Ο πλήρης κύκλος πελάτη σε 4 βήματα: capture, nurture, convert, retain. Δες πώς μπαίνει σε λειτουργία σε ένα boutique ταξιδιωτικό γραφείο.",
  alternates: { canonical: "/pos-leitourgei" },
  openGraph: {
    title: "Πώς Λειτουργεί — SkydreamLabs",
    description:
      "Capture → nurture → convert → retain. Η ροή που μετατρέπει enquiries σε πιστούς πελάτες.",
    url: `${getSiteUrl()}/pos-leitourgei`,
  },
};
    ...
    <div>
      <section className="container-editorial pt-20 pb-14 md:pt-28 md:pb-20">
        ...
        <p className="mt-6 max-w-2xl text-lg text-ink-soft">
          Δεν χρειάζεσαι 6 tools. Χρειάζεσαι μία ροή που ξέρει πού είσαι, τι χρωστάς σε ποιον, και
