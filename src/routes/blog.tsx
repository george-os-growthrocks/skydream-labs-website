...
export const Route = createFileRoute("/blog")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Playbooks και οδηγοί για ταξιδιωτικά γραφεία: CRM, conversion, follow-ups, retention. Πρακτικές συμβουλές, χωρίς fluff." },
      { property: "og:title", content: "Blog — SkydreamLabs" },
      { property: "og:description", content: "Playbooks για marketing automation ταξιδιωτικών γραφείων." },
  ...
  return (
    <div className="container-editorial pt-20 pb-16 md:pt-28">
      ...
      <p className="mt-6 max-w-2xl text-lg text-ink-soft">
        Πρακτικές συμβουλές για CRM, conversion, retention και lifecycle emails. Γραμμένα για boutique operators —
        όχι για SaaS εταιρείες που δεν έχουν πουλήσει ποτέ ταξίδι.
      </p>
      ...
      <div className="mt-14">
        <p className="font-mono text-[10px] uppercase tracking-widest text-coral">Υποστηρικτικά άρθρα</p>
