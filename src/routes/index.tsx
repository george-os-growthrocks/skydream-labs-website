  ...
  head: () => ({
    meta: [
      { title: "SkydreamLabs — Marketing Automation για Ταξιδιωτικά Γραφεία" },
      {
        name: "description",
        content:
          "CRM, pipeline και αυτοματισμοί σχεδιασμένοι για boutique ταξιδιωτικά γραφεία και travel advisors. Σταμάτα να χάνεις enquiries. Μετέτρεψε τις προσφορές σε κρατήσεις.",
      },
      { property: "og:title", content: "SkydreamLabs — Marketing Automation για Ταξιδιωτικά Γραφεία" },
      { property: "og:description", content: "Το λειτουργικό λειτουργεί για σένα, όχι εσύ για αυτό. Marketing automation για ταξιδιωτικά γραφεία." },
...
const pillars = [
  { icon: Inbox, title: "Enquiry capture", body: "Site forms, Instagram, WhatsApp, email — όλα σε ένα inbox με auto-assign και SLA." },
  { icon: Compass, title: "CRM & pipeline", body: "Έξι στάδια φτιαγμένα για travel. Ετικέτες, LTV, ιστορικό, notes σε κάθε επαφή." },
  { icon: MailCheck, title: "Auto follow-up", body: "4-touch ακολουθία 10 ημερών με έξυπνο tone και stop-rules. Χωρίς spam." },
  { icon: Sparkles, title: "Lifecycle", body: "Onboarding, pre-trip, post-trip και anniversary emails — κάθε τι στη σωστή στιγμή." },
];
...
const trust = [
  "Cyclades Bespoke", "Ionian Trails", "Attica Curated", "Meteora & Co.",
  "Chania Voyages", "Aegean Slow Travel", "Northern Passages",
];
  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        <div className="container-editorial grid gap-14 pt-14 pb-20 md:pt-24 md:pb-28 md:grid-cols-[1.05fr_1fr] md:gap-16 items-center">
          <div>
            ...
            >
              Σταμάτα να χάνεις<br />
              <span className="italic text-sea-deep">enquiries</span> στο Instagram,<br />
              στο WhatsApp και<br />
              στα post-it.
            </motion.h1>
            <p className="mt-6 max-w-xl text-lg text-ink-soft leading-relaxed">
              ...
              Ένα σύστημα που μετατρέπει τις προσφορές σε κρατήσεις, αυτοματοποιεί τα follow-ups και κρατά
              ζωντανούς τους πελάτες σου — από το πρώτο "γεια" μέχρι το επόμενο ταξίδι.
            </p>
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <Link to="/epikoinonia" className="inline-flex items-center gap-2 rounded-full bg-sea-deep px-6 py-3 text-sm font-medium text-paper hover:bg-sea">
                Κλείσε 30λεπτό demo <ArrowRight className="h-4 w-4" />
              </Link>
              <Link to="/platforma" className="inline-flex items-center gap-2 rounded-full border border-border-strong px-6 py-3 text-sm font-medium text-ink hover:bg-sand">
                Δες τη πλατφόρμα
              </Link>
            </div>
          ...
          >
            ...
            <div className="hidden md:block absolute -bottom-6 -left-6 rotate-[-6deg] bg-paper rounded-xl border border-border shadow-xl p-4 pr-6 max-w-xs">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-mono text-[10px] uppercase tracking-widest text-ink-soft">enquiry</p>
                  <p className="font-display text-sm">Μαρία → Σαντορίνη · 4 βρ.</p>
                </div>
              </div>
              <div className="mt-3 rule-coral pb-1 text-[10px] font-mono text-ink-soft">status → πρόταση στάλθηκε</div>
            </div>
            <div className="hidden md:block absolute -top-4 -right-4 rotate-[4deg] bg-paper rounded-xl border border-border shadow-xl p-4 max-w-[220px]">
              <p className="font-mono text-[10px] uppercase tracking-widest text-ink-soft">auto follow-up</p>
              <p className="mt-1 font-display text-sm leading-tight">"Πρόσθεσα κάτι που μάλλον σου ταιριάζει"</p>
        ...
        <div className="border-y border-border/60 bg-sand/60 py-4 overflow-hidden">
          <div className="flex gap-14 animate-marquee whitespace-nowrap">
            {[...trust, ...trust].map((t, i) => (
              <span key={i} className="font-display text-lg text-ink/60">{t}</span>
            ))}
          </div>
        </div>
      </section>
        ...
        <div className="grid gap-14 md:grid-cols-2 md:gap-20 items-start">
          <div>
            ...
            <h2 className="mt-4 font-display text-4xl md:text-5xl leading-[1.05] text-ink">
              Δεν χάνεις κρατήσεις γιατί έχεις κακά πακέτα. Χάνεις κρατήσεις γιατί η επικοινωνία γίνεται με ένα Excel και μια μνήμη.
            </h2>
          </div>
          <ul className="space-y-6">
            {[
              ...
              { n: "04", t: "Πελάτες που δεν επιστρέφουν γιατί κανείς δεν τους θύμισε ότι υπάρχεις." },
            ].map((x) => (
              <li key={x.n} className="grid grid-cols-[auto_1fr] gap-5 border-b border-border pb-6 last:border-0">
      ...
      <section className="container-editorial mt-24">
        <SectionHeading
          eyebrow="Το προϊόν"
          title={<>Ένα σύστημα, φτιαγμένο για <span className="italic">travel</span> ροές.</>}
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          {pillars.map((p) => (
            <div key={p.title} className="group rounded-2xl border border-border bg-card p-6 hover:border-coral/60 transition-colors">
      ...
      <section className="container-editorial mt-24 grid gap-14 md:grid-cols-[1fr_1.1fr] md:gap-20 items-center">
        ...
        <div>
          ...
          <ol className="mt-8 space-y-6">
            {[
              { s: "Capture", t: "Κάθε enquiry πέφτει αυτόματα στο pipeline με source, timestamp, SLA." },
              { s: "Nurture", t: "Discovery questionnaire, tagging, ζεστό follow-up εκεί που πρέπει." },
              { s: "Convert", t: "4-touch sequence σε 10 μέρες με stop-rules και ξεκάθαρα CTAs." },
              { s: "Retain", t: "Onboarding, pre-trip, post-trip, anniversary — δωρεάν loyalty engine." },
            ].map((x, i) => (
          ...
          <Link to="/pos-leitourgei" className="mt-8 inline-flex items-center gap-2 font-mono text-xs uppercase tracking-widest text-coral hover:gap-3 transition-all">
      ...
      <section className="container-editorial mt-24">
        <figure className="max-w-4xl mx-auto text-center">
          ...
          <blockquote className="mt-6 font-display text-3xl md:text-5xl leading-[1.1] text-ink">
            "Δεν στέλνουμε <em className="text-coral">πιο πολλά</em>. Σταματήσαμε να χάνουμε αυτά που είχαμε στα χέρια μας."
          </blockquote>
          <figcaption className="mt-6 font-mono text-xs uppercase tracking-widest text-ink-soft">Boutique operator · Αθήνα</figcaption>
        </figure>
      </section>
      ...
      <section className="container-editorial mt-24">
        <div className="flex flex-wrap items-end justify-between gap-6">
          ...
          />
          <Link to="/blog" className="inline-flex items-center gap-2 font-mono text-xs uppercase tracking-widest text-coral">
